...
def exibir_churn():
    ...
    ax.set_xlabel('Mês/Ano', fontsize=12, color='#FF8C00')
    ax.set_ylabel('Churns previstos', color='#FF8C00')
    ...
    ax2.set_xlabel('Mês/Ano', fontsize=12, color='#FF8C00')
    ax2.set_ylabel('Valor perdido (R$)', color='#FF8C00')
